...
$id=$_SESSION['email'];
$sql = "select * from seller s join area a where s.area_id = a.area_id and email = '".$id."'";
                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
													...
													<div class="col-sm-8">
													<input type="text" name="txtname" class="form-control"  placeholder="user name" value="<?php echo $row['seller_name']?>">
													</div>
                                                </div>
												 <div class="form-group">
...
{
if (isset($_POST["t2"]) && isset($_POST["txtname"]) && isset($_POST["txtemail"]) && isset($_POST["txtno"])  && isset($_POST["txtadd"])&& isset($_POST["txtpass"]))
{
	$area_id =$_POST["t2"];
	$name = $_POST["txtname"];
	...
	if ($area_id!='' && $name!='' && $email!='' && $contact!='' && $address!=''  && $password!='')
	{
		$sql = "update seller set area_id='".$area_id."' ,seller_name='".$name."',email='".$email."',contact_no='".$contact."' ,address='".$address."' ,password='".$password."'
		where email = '".$id."' ";
