												...
												<div class="main-content col-sm-9 col-6 layout-grid">
													...
													<div id="collection">
														...
														<div class="collection-items clearfix">
															<div class="products">  
<?php 
$sql="select * from product p join seller s join gallery g join sub_category c join category t where p.seller_id=s.seller_id and p.product_id=g.product_id and p.sub_category_id=c.sub_category_id and c.category_id=t.category_id and sub_category_name='watch' and category_name='kids'";
