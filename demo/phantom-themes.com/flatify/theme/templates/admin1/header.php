...
<!-- Mirrored from phantom-themes.com/flatify/theme/templates/admin1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Dec 2018 11:21:35 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <a class="logo-box" href="index.html"><span>Flatify</span><i class="icon-radio_button_unchecked" id="fixed-sidebar-toggle-button"></i>
                ...
                <div class="page-sidebar-inner">
                    <div class="page-sidebar-menu">
                        <ul class="accordion-menu">
                            ...
                            <li>
                                <a href="email.html">
                                    <i class="menu-icon icon-inbox logo-menu-email"></i><span>Email</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <div class="logo-sm">
                                    ...
                                    <a class="logo-box" href="index.html"><span>Flatify</span></a>
                                </div>
