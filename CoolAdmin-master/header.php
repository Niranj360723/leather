...
<!-- HEADER MOBILE-->
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="index.php">
                    <img src="images/icon/logo.png" height="150px" width="200px" alt="Leather Vortal" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="index.php">Niranj Munjpara</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="index.php">
                                                        <img src="profile.png" alt="Niranj munjpara" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Niranj Munjpara</a>
                                                    </h5>
                                                    <span class="email">niranj2021@gmail.com</span>
                                                </div>
                                            </div>
